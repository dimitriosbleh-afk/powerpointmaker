...
const palettes = {
  ...
  foundation: [
    // [0] Blueprint Grid — deep navy / steel blue / bright teal / red
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "D0DFEF", SUBTITLE: "A8C0D8",
    ...
    // [1] Forest Calculation — dark green / teal / amber / crimson
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C8E8D0", SUBTITLE: "A0D0B0",
    ...
    // [2] Slate & Copper — dark slate / charcoal blue / copper-orange / dark red
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "CBD5E0", SUBTITLE: "A0B0C8",
    ...
    // [3] Ocean Logic — deep ocean blue / aquamarine / gold / brick
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C0D8E8", SUBTITLE: "90C0D8",
    ...
    // [4] Graphite & Lime — dark graphite / forest / lime-gold / berry
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C8D0C8", SUBTITLE: "A0B0A0",
    ...
    // [5] Cobalt Precision — cobalt / purple-grey / bronze / maroon
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C8D0F0", SUBTITLE: "A0B0E0",
  ...
  grade1: [
    // [0] Blueprint Grid
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "CDDDEC", SUBTITLE: "A5BDD5",
    ...
    // [1] Forest Calculation
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C5E5CD", SUBTITLE: "9ECEAD",
    ...
    // [2] Slate & Copper
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C8D2DD", SUBTITLE: "9EADC5",
    ...
    // [3] Ocean Logic
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "BDD5E5", SUBTITLE: "8EBDD5",
    ...
    // [4] Graphite & Lime
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C5CDC5", SUBTITLE: "9EAD9E",
    ...
    // [5] Cobalt Precision
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C5CDED", SUBTITLE: "9EADDD",
  ...
  grade2: [
    // [0] Blueprint Grid
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "CADAE9", SUBTITLE: "A2BAD2",
    ...
    // [1] Forest Calculation
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C2E2CA", SUBTITLE: "9CCAAA",
    ...
    // [2] Slate & Copper
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C5CFDA", SUBTITLE: "9CAAC2",
    ...
    // [3] Ocean Logic
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "BAD2E2", SUBTITLE: "8CBAD2",
    ...
    // [4] Graphite & Lime
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C2CAC2", SUBTITLE: "9CAA9C",
    ...
    // [5] Cobalt Precision
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C2CAEA", SUBTITLE: "9CAADA",
  ...
  grade34: [
    // [0] Blueprint Grid
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C8D8E6", SUBTITLE: "A0B8CF",
    ...
    // [1] Forest Calculation
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C0DFC8", SUBTITLE: "9AC6A8",
    ...
    // [2] Slate & Copper
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C2CCD5", SUBTITLE: "9AA8BF",
    ...
    // [3] Ocean Logic
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "B8D0E0", SUBTITLE: "8AB8CF",
    ...
    // [4] Graphite & Lime
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C0C8C0", SUBTITLE: "9AA89A",
    ...
    // [5] Cobalt Precision
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C0C8E8", SUBTITLE: "9AA8D8",
  ...
  grade56: [
    // [0] Blueprint Grid
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C5D5E4", SUBTITLE: "9EB5CC",
    ...
    // [1] Forest Calculation
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "BDDCC5", SUBTITLE: "98C4A5",
    ...
    // [2] Slate & Copper
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "C0CAD2", SUBTITLE: "98A5BC",
    ...
    // [3] Ocean Logic
    {
      ...
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "B5CDDD", SUBTITLE: "88B5CC",
    ...
    // [4] Graphite & Lime
    {
      PRIMARY: "3A3D45", SECONDARY: "3A6A4C", ACCENT: "636E1A",
      ALERT: "82285A", SUCCESS: "227A4A", ASSESS: "583A7A",
      BG_DARK: "3A3D45", BG_LIGHT: "F4F6F4", BG_CARD: "FFFFFF", WHITE: "FFFFFF",
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "BDC5BD", SUBTITLE: "98A598",
    ...
    // [5] Cobalt Precision
    {
      PRIMARY: "284C92", SECONDARY: "5A4872", ACCENT: "846A2C",
      ALERT: "74223A", SUCCESS: "227552", ASSESS: "382A8A",
      BG_DARK: "284C92", BG_LIGHT: "F4F6FC", BG_CARD: "FFFFFF", WHITE: "FFFFFF",
      CHARCOAL: "2C2C2C", MUTED: "5F6E7A", TEXT_ON_DARK: "BDC5E5", SUBTITLE: "98A5D5",
