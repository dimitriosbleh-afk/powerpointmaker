...
// Holes Unit - Lesson 7 (Week 2, Session 4): Persuasive Counter-Argument + Conclusion
// Year 5/6 Literacy
...
const FOOTER = "Counter + Conclusion | Lesson 7 | Week 2 | Year 5/6 Literacy | Holes";
const OUT_DIR = "output/Holes_Lesson7_Counter_Conclusion";
...
- Last persuasive lesson of Week 2
...
DO:
- Display title slide
- Read 2-3 upgraded sentences from yesterday's exit ticket (no names) to celebrate
- Have student PEEL paragraphs from Lesson 5 + 6 ready on desks

TEACHER NOTES:
This lesson finishes Week 2. By the end, students will have:
- an introduction (Lesson 4)
- one upgraded PEEL body paragraph (Lessons 5 + 6)
- one counter-argument paragraph (today)
- a conclusion (today)

In Week 3 they choose narrative OR persuasive for the publish piece. They will already have a complete short persuasive draft.
...
- Have student paragraphs from Lessons 4-6 back on desks
...
TEACHER NOTES:
SC1 -- one sentence that acknowledges the other side. Achievable. SC2 (target) -- counter-argument (acknowledge + rebut + link) + a conclusion that ends on a strong line. SC3 -- a conclusion that uses one rhetorical device or a call to action.
...
TEACHER NOTES:
We Do uses the OTHER side from yesterday's I Do. Same structure, different position. This proves the move works on any side.
...
TEACHER NOTES:
OPTIONAL. Use only if CFU < 80%. Different approach: a THREE-SENTENCE FRAME that locks the three moves in place.
...
ENABLING & EXTENDING:
ENABLING PROMPT:
- Task: Use the sentence frames on the back of the mentor sheet for both the counter and the conclusion. Pick ONE acknowledged point from your partner's other-side discussion
...
TEACHER NOTES:
Today is the densest writing day of the unit. Students complete a short persuasive piece (intro + body + counter + conclusion). Some will not finish -- that is fine. They will revisit it in Week 3 if they choose persuasive for publish.
...
- Last lesson of Week 2 -- you have completed a short persuasive piece
- Self-check: show on fingers 1 to 5
- Partner share: what is the BEST sentence in your persuasive piece?
- Next week: PUBLISH. You choose narrative or persuasive

DO:
- Run fingers check
- 60 seconds partner share -- let them enjoy what they wrote
- Briefly: "Next week we PUBLISH. One piece. Display in our classroom"

TEACHER NOTES:
End Week 2 with genuine acknowledgement. Students have written a complete short persuasive piece in 4 sessions -- that is real work. Have student work ready to return at the start of Week 3.

[Literacy: Closing | VTLM 2.0: Review and Reflect / End of Week 2]`;
...
async function build() {
  ...
  pres.author = "Claude";
  pres.title = "Holes -- Lesson 7 -- Counter + Conclusion";
  ...
  titleSlide(
    ...
    "Lesson 7  |  Week 2  |  Year 5/6 Literacy",
    NOTES_TITLE
  );
  ...
  // SLIDE 15 -- Closing (end of Week 2)
  closingSlide(
    pres,
    {
  ...
  let planY = addPdfHeader(plan, "Counter-Argument + Conclusion Plan", {
    ...
    lessonInfo: "Lesson 7 | Week 2 | Year 5/6 Literacy | Holes",
    showNameDate: true,
  });
  ...
  addPdfFooter(plan, "Lesson 7 | Counter Plan -- Page 1");
  ...
  let planY2 = addPdfHeader(plan, "PART 2 -- Conclusion Plan", {
    ...
    lessonInfo: "Lesson 7 | Week 2 | Year 5/6 Literacy",
    showNameDate: false,
  });
  ...
  addPdfFooter(plan, "Lesson 7 | Conclusion Plan -- Page 2");
  ...
  addPdfFooter(plan, "Lesson 7 | Exit Ticket");
  ...
  addPdfFooter(mp, "Lesson 7 | Mentor Counter + Conclusion -- REFERENCE");

  await Promise.all([
    pres.writeFile({ fileName: `${OUT_DIR}/Holes_Lesson7.pptx` }),
    writePdf(plan, PLAN_PDF_PATH),
    writePdf(mp, MENTOR_PDF_PATH),
  ]);

  console.log("PPTX written to " + `${OUT_DIR}/Holes_Lesson7.pptx`);
