...
contentSlide(
  ...
  composeGlanceNotes({
    answer: "open - listen for rain falling from clouds, then water soaking in or running to rivers",
    beats: [
      "ASK: Where does rain come from, and where does it go? 30 sec, turn and tell. EXPECT: from clouds, then soaks in or runs to rivers.",
      "COLLECT two or three ideas, do not correct yet. SAY: Today we follow water's whole journey and name each part.",
      "POINT to the puddle. SAY: A puddle dries on a hot day - hold onto where that water went.",
    ],
    trap: "thinking clouds make brand new water. Fix: name it as the same water moving, proved on the cycle.",
...
cycleDiagramSlide(
  ...
  STAGES_FULL,
  composeGlanceNotes({
    answer: "evaporation, condensation, precipitation, collection, then round again",
    beats: [
      "POINT to evaporation. SAY: Follow one drop. The sun heats the sea and water rises as vapour.",
      "MODEL the arrows. SAY: High up it cools into clouds. Full clouds drop rain or snow.",
      "SAY: Water collects in rivers and sea, then the sun heats it again. Watch the arrow return.",
      "SAY: Same water, moving and changing. The return arrow makes it a cycle.",
    ],
    trap: "thinking each part is different water. Fix: trace one drop round, naming it the same water.",
    stretch: "where does the energy driving the whole cycle come from? (the sun)",
    help: "four word cards, student places each beside its arrow as you narrate.",
...
contentSlide(
  ...
  composeGlanceNotes({
    answer: "open - a labelled cycle in order, arrows showing movement, and a sentence on why it repeats",
    beats: [
      "SAY: Now just you, in your science journal. Draw the cycle and label all four parts.",
      "SAY: Add arrows to show the water moving, then one sentence on why it is a cycle.",
      "CIRCULATE. If stuck on names, point to the order, not the answer. Offer the scaffold.",
    ],
    trap: "drawing the parts with no arrows. Fix: prompt for arrows - they make the loop.",
    stretch: "label where the sun's energy powers the cycle, or add groundwater at collection.",
    help: "Water Cycle Scaffold - diagram pre-drawn, word bank, sentence to finish.",
